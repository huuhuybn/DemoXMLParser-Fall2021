...
import vn.edu.poly.demoxmlparser.adapter.NewAdapter;
...
public class MainActivity extends AppCompatActivity {
    ...
    class GetDataTask extends AsyncTask<String, Long, List<News>> {
        ...
        protected void onPostExecute(List<News> news) {
            ...
            newAdapter = new NewAdapter(MainActivity.this, news);
            lvList.setAdapter(newAdapter);
            lvList.setLayoutManager(new LinearLayoutManager(MainActivity.this));
